...
ifdef XGETTEXT
XGETTEXT += -ctranslator --copyright-holder='CloudberryDB Project' --msgid-bugs-address=dev@cloudberry.apache.org --no-wrap --sort-by-file --package-name='$(CATALOG_NAME) (CloudberryDB)' --package-version='$(MAJORVERSION)'
endif
